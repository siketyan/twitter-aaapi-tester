...
//                 Siketyan <https://github.com/Siketyan>
...
declare module 'twit' {
    ...
    class Twit {
        ...
        /**
         * @see https://github.com/ttezel/twit/blob/master/lib/twitter.js#L71
         */
        delete(path: string, callback: Twit.Callback): void;
        delete(path: string, params: Twit.Params, callback: Twit.Callback): void;
        delete(path: string, params?: Twit.Params): Promise<Twit.PromiseResponse>;
